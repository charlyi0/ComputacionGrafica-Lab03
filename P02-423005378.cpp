...
{
	// --- LETRA J (Azul) ---
	// 3 rectángulos = 6 triángulos = 18 vértices * 6 datos  = 108
	GLfloat vertices_J[] = {
	...
	// --- LETRA T (Roja) ---
	// 2 rectángulos = 4 triángulos = 12 vértices * 6 datos = 72 
	GLfloat vertices_T[] = {
	...
	// --- LETRA C (Verde) ---
	// 3 rectángulos = 6 triángulos = 18 vértices * 6 datos = 108 floats
	GLfloat vertices_C[] = {
