...
int main()
{
	...
	// 1. Declaración de la luz puntual blanca
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(-.1f, -0.1f, 0.8f));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(6.25f, -.1f, 0.8f));
		model = glm::scale(model, glm::vec3(1.8f, 1.8f, 2.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Llanta_M.RenderModel();
		...
		direccionMundoHeli = glm::mat3(modelauxHeli) * glm::vec3(0.0f, -1.0f, 0.0f);
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(5.0f, -0.9f, -15.0f)); 
		modelauxFaro = model;
		posLuzFaroMundo = glm::vec3(modelauxFaro * localLuzFaro);
		pointLights[1].SetPos(posLuzFaroMundo);
